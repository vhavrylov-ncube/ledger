...
void Analyser::Initialise()
{
  ...
  CreateClassType("UInt256", TypeIndex(typeid(UInt256Wrapper)), TypeIds::UInt256, uint256_type_);
  EnableOperator(uint256_type_, Operator::Equal);
  EnableOperator(uint256_type_, Operator::NotEqual);
  EnableOperator(uint256_type_, Operator::LessThan);
  EnableOperator(uint256_type_, Operator::LessThanOrEqual);
  EnableOperator(uint256_type_, Operator::GreaterThan);
  EnableOperator(uint256_type_, Operator::GreaterThanOrEqual);
  EnableOperator(uint256_type_, Operator::Add);
  EnableOperator(uint256_type_, Operator::InplaceAdd);
  EnableOperator(uint256_type_, Operator::Subtract);
  EnableOperator(uint256_type_, Operator::InplaceSubtract);
  EnableOperator(uint256_type_, Operator::Multiply);
  EnableOperator(uint256_type_, Operator::Divide);
  EnableOperator(uint256_type_, Operator::InplaceMultiply);
  EnableOperator(uint256_type_, Operator::InplaceDivide);
